...
<body>
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="{{ url('')}} " class="logo"><b>ADMIN COMMU ID</b></a>
            <!--logo end-->
        ...
        <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="#"><img src="{{ asset('css/theme/assets/img/businessman.png') }}" class="img-circle" width="60"></a></p>
                  ...
                  <li class="mt">
                      ...
                      <a  href="{{ url('/') }}">
                          <i class="fa fa-dashboard"></i>
                          <span>List Organisasi/Komunitas</span>
                      </a>
                  </li>
